                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <h6 class="date-time"> <i class="fa fa-hourglass-start"></i> {!!date('F d, Y | h:mA', strtotime($event->start_date))!!}</h6>
                            <h6 class="date-time"> <i class="fa fa-hourglass-end"></i> {!!date('F d, Y | h:mA', strtotime($event->end_date))!!}</h6>
